...
class GooglePlayService
{
    ...
    public function __construct()
    {
        ...
        $this->client->setAuthConfig(env('GOOGLE_PLAY_API_KEY_PATH',"../konnected-service-account-google-play.json"));
    ...
    public function verifyPurchase($productId, $purchaseToken)
    {
        ...
        $packageName = env('GOOGLE_PLAY_PACKAGE_NAME','com.konnectedlives.app');
        try {
