        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="p-4">
                        <form method="post" action="{{route('faq.faq-store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="input-group input-group-dynamic mb-4 focused is-focused">
                                    <label class="form-label">Question</label>
                                    <input type="text" class="form-control" name="question" autocomplete="off">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="input-group input-group-dynamic mb-4 focused is-focused">
                                    <textarea id="answer" name="answer" class="form-control validate" name="answer"  rows="5" placeholder="Answer" spellcheck="false"></textarea>
                                </div>
